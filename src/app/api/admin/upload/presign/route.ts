...
import { generateDataKey, generateIv, getActiveMasterKey, shouldForceSse, wrapDataKey } from "@/lib/encryption";
...
if (!canUpload.ok) {
    ...
    `;
        ...
        // Enforce server-side encryption at rest at the object layer when supported.
        if (shouldForceSse()) {
