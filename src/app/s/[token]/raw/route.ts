...
// Uses uuid if token looks like uuid; otherwise text.
...
export async function GET(
    ...
    // 2) fetch doc storage (assumes your docs table has r2_bucket + r2_key)
  ...
  `) as {
    ...
    // 4) stream from R2 (supports range for PDF seeking)
