...
const subtle = "text-xs font-medium uppercase tracking-[0.16em] text-[var(--text-faint)]";
            ...
            <div className="mt-3 space-y-2">
              ...
              {canSeeAll ? (
                <form action={disableAliasForDocAction}>
                  <input type="hidden" name="docId" value={docId} />
                  <button type="submit" className="inline-flex rounded-sm border border-[color:rgba(186,71,50,0.2)] bg-[color:rgba(186,71,50,0.08)] px-3 py-2 text-xs font-medium text-[var(--danger)] transition hover:bg-[color:rgba(186,71,50,0.12)]">
                    Disable alias
                  </button>
                </form>
              ) : null}
