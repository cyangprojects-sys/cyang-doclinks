// src/app/d/[alias]/actions.server.ts
"use server";

import { z } from "zod";
import { sql } from "@/lib/db";
import { requireOwner } from "@/lib/owner";
import { CreateSchema, type CreateShareResult, type ShareStatsResult, type RevokeShareResult } from "./actions.types";
...
export async function createAndEmailShareToken(
    ...
    `) as unknown as Array<{
      ...
      `;
            ...
            // best-effort email; don't fail the action if Resend errors
            try {
